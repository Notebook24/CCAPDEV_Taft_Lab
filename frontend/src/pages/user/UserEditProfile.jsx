...
function UserEditProfile() {
  ...
  return (
    <div className="user-edit-profile-page">
      <header>
        ...
        <div className="header-right">
          ...
          <div className="profile-icon">
            <a href="/user/profile">
              <img src={getProfilePictureUrl()} alt="Profile Icon"
        ...
        <div className="profile-container">
          <div className="profile-header">
            <div style={{ position: 'relative' }}>
              <img src={getProfilePictureUrl()} alt="User-Picture" className="user-icon"
                style={{ width: '80px', height: '80px', borderRadius: '50%', objectFit: 'cover' }} />
              <button onClick={openUploadModal} style={{
                position: 'absolute', bottom: 0, right: 0, background: '#006937',
      ...
      {/* Upload Modal */}
      <div className={`modal-backdrop ${isUploadModalOpen ? 'is-open' : ''}`}
        onClick={(e) => { if (e.target === e.currentTarget) closeUploadModal(); }}>
        <div className="modal-card">
          <h3>Upload Profile Picture</h3>
          <input type="file" accept="image/jpeg,image/jpg,image/png,image/gif" onChange={handleFileSelect}
            style={{ marginTop: '15px', width: '100%', border: '1px solid #333', padding: '5px', borderRadius: '10px' }} />
          {selectedFile && <p style={{ fontSize: '12px', color: '#666', marginBottom: '15px' }}>Selected: {selectedFile.name}</p>}
