...
// Add another lab techincian account
function AdminAddLabTechnician() {
    const navigate = useNavigate();
    // Object where the new lab techinican account details are stored
    ...
    // Updates the state of formData whenever the user types in the input fields
    const handleChange = (e) => {
        const { name, value } = e.target;
        setFormData(prev => ({ ...prev, [name]: value }));
    };

    // Submits account details to backend and calls API to create a new lab technician account
    const handleSubmit = async (e) => {
        ...
        // Call the API for creating/posting new lab technician account
        try {
          ...
          // Send message if creation of new lab technician account is succesful
